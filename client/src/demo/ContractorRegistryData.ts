...
export const equipmentTypes: string[] = ["Feller Buncher", "Forwarder", "Processor", "Cat processor", "Cut-to-length machinery", "Tree length equipment"];
export const operationTypes: string[] = ["Softwood", "cut-to-length", "Tree length", "Long and short wood processing", "stumpside delivery"];